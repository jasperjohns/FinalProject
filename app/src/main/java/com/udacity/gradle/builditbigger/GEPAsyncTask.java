 ...
 */
public class GEPAsyncTask {


    private IGEPListener igepListener;

    public GEPAsyncTask( IGEPListener igepListener )
    {
        this.igepListener = igepListener;
    }
...
*/
            igepListener.processCompleted(result);
